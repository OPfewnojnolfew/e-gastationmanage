$(function() {
    ...
    $.get('assets/js/index.json', function(res) {
            if (res.err_code == 0) {
                consumeGrowth.setOption(getLineChartsOptions('充值趋势', '充值额度', res.consumeGrowth));
                payGrowth.setOption(getLineChartsOptions('消费趋势', '消费额度', res.payGrowth));
            }
        })
